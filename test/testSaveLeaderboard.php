...
try {
    ...
    $ch = curl_init('http://localhost/ovningar/Lightquiz/API/saveLeaderboard.php');
...
function leaderboardSaveOk($curlHandle) {
    ...
    if($status===200) {
        ...
        $db->exec("DELETE FROM `leaderboard` WHERE `name` = 'nameTest';");
    } else {
